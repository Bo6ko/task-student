...
class CI_Pagination {
	...
	var $first_link   		= FALSE;//'&lsaquo;&lsaquo;';
	var $next_link			= 'Next';
	var $prev_link			= 'Previous';
	var $last_link			= FALSE;//'&rsaquo;&rsaquo;';
	var $uri_segment		= 3;
	var $full_tag_open		= '<div class="block_pagination_1">';
	var $full_tag_close		= '</div>';
	var $first_tag_open		= '<li>';
	var $first_tag_close	= '</li>';
	var $last_tag_open		= '<div class="page_num">';
