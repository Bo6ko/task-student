<?php /* Smarty version Smarty-3.1.8, created on 2019-09-17 15:14:18
         compiled from "application/views\admin\publishers\create.htm" */ ?>
<?php /*%%SmartyHeaderCode:18125d80d1b2a3b907-53663146%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'ff9da18611a9796806a1933709c7c9843497556d' => 
    array (
      0 => 'application/views\\admin\\publishers\\create.htm',
      1 => 1568726047,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '18125d80d1b2a3b907-53663146',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.8',
  'unifunc' => 'content_5d80d1b2ba3bf0_28292529',
  'variables' => 
  array (
    'post' => 0,
    'data' => 0,
...
<?php if ($_valid && !is_callable('content_5d80d1b2ba3bf0_28292529')) {function content_5d80d1b2ba3bf0_28292529($_smarty_tpl) {?><div class="content-main">
	...
	<form class="admin-form" method="post" action="">
		...
		<div class="field">
			...
			<input id="publisher_name" type="text" name="publisher_name" value="<?php if (isset($_smarty_tpl->tpl_vars['post']->value['publisher_name'])&&!empty($_smarty_tpl->tpl_vars['post']->value['publisher_name'])){?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['post']->value['publisher_name'], ENT_QUOTES, 'UTF-8', true);?>
...
" <?php if (isset($_smarty_tpl->tpl_vars['post']->value['country_id'])&&$_smarty_tpl->tpl_vars['post']->value['country_id']==$_smarty_tpl->tpl_vars['country']->value['country_id']){?>selected="selected"<?php }?>> <?php echo $_smarty_tpl->tpl_vars['country']->value['country_name'];?>
 </option>
				<?php } ?>
				<?php }?>
			</select>
		...
		<div class="field">
			...
			<input id="publisher_city" type="text" name="publisher_city" value="<?php if (isset($_smarty_tpl->tpl_vars['post']->value['publisher_city'])&&!empty($_smarty_tpl->tpl_vars['post']->value['publisher_city'])){?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['post']->value['publisher_city'], ENT_QUOTES, 'UTF-8', true);?>
<?php }?>" placeholder="publisher city">
		...
		<div class="field">
			...
			<input id="publisher_address" type="text" name="publisher_address" value="<?php if (isset($_smarty_tpl->tpl_vars['post']->value['publisher_address'])&&!empty($_smarty_tpl->tpl_vars['post']->value['publisher_address'])){?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['post']->value['publisher_address'], ENT_QUOTES, 'UTF-8', true);?>
<?php }?>" placeholder="publisher address">
		...
		<div class="field">
			...
			<input id="publisher_postcode" type="text" name="publisher_postcode" value="<?php if (isset($_smarty_tpl->tpl_vars['post']->value['publisher_postcode'])&&!empty($_smarty_tpl->tpl_vars['post']->value['publisher_postcode'])){?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['post']->value['publisher_postcode'], ENT_QUOTES, 'UTF-8', true);?>
<?php }?>" placeholder="publisher postcode">
		...
		<div class="field">
			...
			<input id="publisher_email" type="text" name="publisher_email" value="<?php if (isset($_smarty_tpl->tpl_vars['post']->value['publisher_email'])&&!empty($_smarty_tpl->tpl_vars['post']->value['publisher_email'])){?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['post']->value['publisher_email'], ENT_QUOTES, 'UTF-8', true);?>
<?php }?>" placeholder="publisher email">
		...
		<div class="field">
			...
			<input id="publisher_phone" type="text" name="publisher_phone" value="<?php if (isset($_smarty_tpl->tpl_vars['post']->value['publisher_phone'])&&!empty($_smarty_tpl->tpl_vars['post']->value['publisher_phone'])){?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['post']->value['publisher_phone'], ENT_QUOTES, 'UTF-8', true);?>
<?php }?>" placeholder="publisher phone">
		...
		<div class="field">
			...
			<input id="publisher_domain" type="text" name="publisher_domain" value="<?php if (isset($_smarty_tpl->tpl_vars['post']->value['publisher_domain'])&&!empty($_smarty_tpl->tpl_vars['post']->value['publisher_domain'])){?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['post']->value['publisher_domain'], ENT_QUOTES, 'UTF-8', true);?>
<?php }?>" placeholder="publisher domain">
		...
		<div class="field">
			...
			<input id="publisher_bulstat" type="text" name="publisher_bulstat" value="<?php if (isset($_smarty_tpl->tpl_vars['post']->value['publisher_bulstat'])&&!empty($_smarty_tpl->tpl_vars['post']->value['publisher_bulstat'])){?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['post']->value['publisher_bulstat'], ENT_QUOTES, 'UTF-8', true);?>
...
" <?php if (isset($_smarty_tpl->tpl_vars['post']->value['administrator_id'])&&$_smarty_tpl->tpl_vars['post']->value['administrator_id']==$_smarty_tpl->tpl_vars['administrator']->value['administrator_id']){?>selected="selected"<?php }?>> <?php echo $_smarty_tpl->tpl_vars['administrator']->value['administrator_firstname'];?>
 </option>
					<?php } ?>
				<?php }?>
			</select>
